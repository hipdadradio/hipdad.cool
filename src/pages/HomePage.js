    ...
    render() {
        return (
            <div className="homeContainer">
                ...
                <h4 className="textContainer">Hip Dad Radio is an multimedia worldide entertainment conglomerate. Fron the paris of the plains to THE American City, head south for a little southern comfort. Echoing off the cold walls of the Berlin night clubs. An endless stream of content fuels these jets. Hip Dad Radio is the future of internet radio. Welcome.</h4>
